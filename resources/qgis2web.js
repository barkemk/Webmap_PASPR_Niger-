...
map.getView().fit([219180.017483, 1459162.347664, 258464.949718, 1479039.051027], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Carte web des activités du Projet d’Appui à la Stabilisation de la Situation Socio-économique des Populations Retournées(PASPR)</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (217 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Une cartographie des infrastructures et des activités génératrices des revenus au bénéfice des populations retournées dans leurs villages d’origine dans la Région de Diffa. Le PASPR est financé par l’Union européenne.';
            }
